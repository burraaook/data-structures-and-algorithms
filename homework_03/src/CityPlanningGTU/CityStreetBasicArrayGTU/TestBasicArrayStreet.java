...
/**
 * Class for testing BasicArrayStreet class.
 * @author Burak Kocausta
 */ 
public class TestBasicArrayStreet {

	/**
	 * Method to test BasicArrayStreet class
	 */ 
	public static void testBasicArrayStreet ( ) {
		try {
			System.out.println( "___TESTING BasicArrayStreet class___\n" );

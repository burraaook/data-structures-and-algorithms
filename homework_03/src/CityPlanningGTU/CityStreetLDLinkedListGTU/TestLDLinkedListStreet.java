...
/**
 * Class for testing LDLinkedListStreet class.
 * @author Burak Kocausta
 */ 
public class TestLDLinkedListStreet {



  /**
     * Method to test LDLinkedListStreet class
     */ 
    public static void testLDLinkedListStreet ( ) {
        try {

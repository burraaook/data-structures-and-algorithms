...
/**
 * 
 * LDLinkedListStreet class provides a buildable two dimensional, and two sided space for CityBuilding type buildings.
 * @version 1.0 18.03.2022
 * @author Burak Kocausta
 * 
 */
public class LDLinkedListStreet implements Cloneable {

    /** 
     *  CityBuilding arrays to store lands.  
     */
    private LDLinkedList<CityBuilding> frontBuildings;
    private LDLinkedList<CityBuilding> backBuildings;
     ...
     */ 
    public LDLinkedListStreet ( ) {
        this.lengthOfStreet = 55;
        this.frontBuildings = new LDLinkedList<CityBuilding>();
        this.backBuildings = new LDLinkedList<CityBuilding>();
     ...
     */ 
    public LDLinkedListStreet ( int lengthOfStreet ) throws Exception {
    ...
    /**
     * Overriden toString method returns information about LDLinkedListStreet object as a String.
    ...
    public boolean equals ( Object other ) {
        if ( other != null && other instanceof LDLinkedListStreet ) {

            final LDLinkedListStreet otherStreet = ( LDLinkedListStreet ) other;
    ...
    public Object clone ( ) {
        ...
        try {
            LDLinkedListStreet copy = ( LDLinkedListStreet ) super.clone();
            copy.frontBuildings = new LDLinkedList<CityBuilding>();
            copy.backBuildings = new LDLinkedList<CityBuilding>();
